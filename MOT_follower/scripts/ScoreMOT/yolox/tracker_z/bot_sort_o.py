...
class BoTSORT(object):
    ...
    def update(self, output_results, img):
        ...
        if self.args.with_reid:
            emb_dists_H = matching.mult_embedding_distance(HighScoreStracks, detections)
        ...
        matches_H, u_track, u_detection = matching.linear_assignment(ious_dists_H, thresh=0.5)
        ...
        if self.args.with_reid:
            emb_dists_L = matching.embedding_distance(LowScoreStracks, detections)
        ...
        # matches_L, u_track, u_detection = matching.linear_assignment(dists_L, thresh=0.8)
