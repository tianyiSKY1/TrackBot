...
from yolox.tracker_z.scoremot import ScoreMOT
...
def make_parser():
    ...
    return parser
exp_file = "/home/rosz/wheeltec/src/simple_follower/scripts/ByteTrack/exps/example/mot/yolox_s_mix_det.py"
ckpt = "/home/rosz/wheeltec/src/simple_follower/scripts/ByteTrack/pretrained/bytetrack_s_mot17.pth.tar"
device = "gpu"
conf = None
nms = None
tsize = None
...
def imageflow_demo(predictor, vis_folder, current_time, args):
    ...
    tracker = ScoreMOT(frame_rate=30)
    timer = Timer()
    frame_id = 0
    results = []
    while True:
...
class ImageSubscriber(object):
    def __init__(self, predictor, vis_folder, current_time, args):
        ...
        self.args = args
        im_sub = message_filters.Subscriber('/camera/color/image_raw', Image, queue_size = 1, buff_size=2**24)
        dep_sub = message_filters.Subscriber('/camera/depth/image_raw', Image, queue_size = 1, buff_size=2**24)
